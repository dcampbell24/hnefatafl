...
#[test]
fn monte_carlo() {
    let mut tree = Tree::new(Game::make(BoardSize::_11, &TimeSettings::UnTimed));
    let depth = 80;
...
#[test]
fn can_not_escape_3() -> anyhow::Result<()> {
    let board: Board = [
        "..XXXX..X..",
        ".X.......X.",
        "X.........X",
...
#[test]
fn can_not_escape_4() -> anyhow::Result<()> {
    let board: Board = [
        ".XXKXX.....",
        "...X.......",
        "...X.......",
...
#[test]
fn can_not_escape_4_more() -> anyhow::Result<()> {
    let board: Board = [
        ".XXKXX.....",
        "...XX......",
        "...XX......",
...
#[test]
fn can_not_escape_5() -> anyhow::Result<()> {
    let board: Board = [
        "...........",
        "X..........",
        "X..........",
...
#[test]
fn can_not_escape_5_more() -> anyhow::Result<()> {
    let board: Board = [
        "...........",
        "...........",
        "...........",
...
#[test]
fn can_not_escape_6() -> anyhow::Result<()> {
    let board: Board = [
        "......X....",
        "..........X",
        "..........X",
...
#[test]
fn can_not_escape_7_more() -> anyhow::Result<()> {
    let board: Board = [
        "......X....",
        "...........",
        "...........",
