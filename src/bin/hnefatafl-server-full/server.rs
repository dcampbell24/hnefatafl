...
use crate::{ARCHIVED_GAMES_FILE, TWO_MONTHS, hash_password, unix_timestamp::UnixTimestamp};
...
pub(crate) struct Server {
    ...
    pub game_id: Id,
    #[serde(default)]
    pub ran_update_rd: UnixTimestamp,
    #[serde(default)]
    ...
    #[serde(skip)]
    pub accounts_old: Accounts,
    #[serde(skip)]
    pub archived_games: Vec<ArchivedGame>,
    #[serde(skip)]
    pub clients: HashMap<usize, mpsc::Sender<String>>,
    #[serde(skip)]
    pub connections: HashMap<String, u128>,
    #[serde(skip)]
    pub games: ServerGames,
    #[serde(skip)]
    pub games_light: ServerGamesLight,
    #[serde(skip)]
    pub games_light_old: ServerGamesLight,
    #[serde(skip)]
    pub skip_the_data_file: bool,
    #[serde(skip)]
    pub texts: VecDeque<String>,
    #[serde(skip)]
    pub tx: Option<mpsc::Sender<(String, Option<mpsc::Sender<String>>)>>,
}
