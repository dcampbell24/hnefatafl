...
use iced::{
    Color, Element, Event, Font, Subscription, Task,
...
pub(crate) struct Client {
    ...
    pub attacker: String,
    #[serde(default)]
    pub archived_games: Vec<ArchivedGame>,
    #[serde(skip)]
    pub archived_games_filtered: Option<Vec<ArchivedGame>>,
    #[serde(skip)]
    pub archived_game_selected: Option<ArchivedGame>,
    #[serde(skip)]
    pub archived_game_handle: Option<ArchivedGameHandle>,
    #[serde(default)]
    ...
    #[serde(skip)]
    pub estimate_score: bool,
    #[serde(skip)]
    pub estimate_score_tx: Option<mpsc::Sender<Tree>>,
    #[serde(skip)]
    pub captures: HashSet<Vertex>,
    #[serde(skip)]
    pub counter: u64,
    #[serde(skip)]
    ...
    #[serde(skip)]
    pub emails_bcc: Vec<String>,
    #[serde(skip)]
    pub error: Option<String>,
    #[serde(skip)]
    pub error_email: Option<String>,
    #[serde(skip)]
    pub error_persistent: Vec<String>,
    #[serde(skip)]
    pub game: Option<Game>,
    #[serde(skip)]
    pub game_id: Id,
    #[serde(skip)]
    pub games_light: ServerGamesLight,
    #[serde(skip)]
    pub game_settings: NewGameSettings,
    #[serde(skip)]
    pub heat_map: Option<HeatMap>,
    #[serde(skip)]
    pub heat_map_display: bool,
    #[serde(default)]
    pub locale_selected: Locale,
    #[serde(skip)]
    pub message: String,
    #[serde(default)]
    pub my_games_only: bool,
    #[serde(skip)]
    pub my_turn: bool,
    #[serde(skip)]
    pub now: i64,
    ...
    pub password: String,
    #[serde(skip)]
    pub password_ends_with_whitespace: bool,
    #[serde(default)]
    pub password_save: bool,
    #[serde(default)]
    pub password_show: bool,
    #[serde(skip)]
    pub play_from: Option<Vertex>,
    #[serde(skip)]
    pub play_from_previous: Option<Vertex>,
    #[serde(skip)]
    pub play_to_previous: Option<Vertex>,
    #[serde(skip)]
    pub press_letters: HashSet<char>,
    #[serde(skip)]
    pub press_numbers: [bool; 13],
    #[serde(skip)]
    ...
    #[serde(skip)]
    pub texts_game: VecDeque<String>,
    #[serde(skip)]
    pub text_input: String,
    #[serde(default)]
    pub theme: Theme,
    #[serde(skip)]
    pub time_attacker: TimeSettings,
    #[serde(skip)]
    pub time_defender: TimeSettings,
    #[serde(skip)]
