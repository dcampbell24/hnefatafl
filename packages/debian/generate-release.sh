...
PACKAGE='hnefatafl-copenhagen_4.5.0-3_amd64.deb'
...
Architectures: amd64
Components: main
Description: A software repository containing Hnefatafl Copenhagen. Website: https://hnefatafl.org Discord: https://discord.gg/h56CAHEBXd
Date: $(date -Ru)
EOF
