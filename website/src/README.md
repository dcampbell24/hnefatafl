...
See how to [install](install.html) the software.

## Rules

See the [rules](rules.html).
...
Join [discord](https://discord.gg/h56CAHEBXd).
...
[Donate](https://github.com/sponsors/dcampbell24).
