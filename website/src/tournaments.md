...
argument `--group-size`, defaulting to 8. Play within a group consists of
...
groups look like this for size 3:
...
Here is an example screenshot of a played out tournament with group size 3:
